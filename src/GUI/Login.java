...
public class Login {
    ...
    public Login() {
        ...
        info_Label = new JLabel("PLEASE LOGIN TO PROCEED FORWARD");
        ...
        Image_jLabel.setIcon(new ImageIcon("projectPic1.jpg"));
    ...
    private class LoginActionListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            switch (e.getActionCommand()) {
                ...
                case "Login": {
                    if (UN_TextField.getText().trim().equalsIgnoreCase("admin101")
                            && String.valueOf(Password_Field.getPassword()).equals("12345")) {
